...
class Basic(Cog_Extension):
    ...
    @commands.command(aliases = ['Profile', 'p', 'P'])
    async def profile(self, ctx):
        embed = discord.Embed(title = 'Profile', color = 0xff004b)
    ...
    @commands.command(aliases = ['Informations', 'info', 'Info'])
    async def informations(self, ctx):
        embed = discord.Embed(title = 'Informations', description = "This bot is my maid. She's definitely a tsundere.", color = 0xff004b)
        ...
        embed.add_field(name ='Library', value = 'discord.py ' + discord.__version__, inline = False)
        embed.add_field(name ='Invite', value = 'https://discord.com/api/oauth2/authorize?client_id=729380731289075773&permissions=506986305&scope=bot', inline = False)
        await ctx.send(embed = embed)

    @commands.command()
    async def ping(self, ctx):
        embed = discord.Embed(title = 'Ping', color = 0xff004b)
    ...
    async def help(self, ctx):
        ...
        embed = discord.Embed(title = 'Help', description = 'List of commands are:', color = 0xff004b)
        ...
        embed.add_field(name = 'm!我是誰', value = 'Check whether you are the master of this maid.', inline = True)
        ...
        embed.add_field(name = 'm!informations/m!Informations/m!info/m!Info', value = 'Gives the informations of this bot', inline = True)
